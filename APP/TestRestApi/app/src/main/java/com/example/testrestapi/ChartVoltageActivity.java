...
public class ChartVoltageActivity extends AppCompatActivity {
    private final String TAG = ChartVoltageActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chart_voltage);

        int tempYear;
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Chart Voltage Total");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(ChartVoltageActivity.this, MainActivity.class);
...
//        }
        ...
        LineDataSet set1 = new LineDataSet(yValuesLineChart, "Daily Voltage (V)");
...
//        }
        ...
        BarDataSet set1 = new BarDataSet(yValuesBarChart, "Monthly Voltage (V)");
